...
public class EmailSenderTest {
  ...
  // };
  // emailService.sendEmail(to, "Namaskar", "This is demo mail from spring boot to
  // multiple users");
  // }

  // @Test
  // public void emailSenderInHTMLFormat() {
  // String htmlContent = "<h1 style='color:red; Text-align:center'>This is Murli
  // Vishwakaram</h1>" +
  // "<p>This is All About me , i am Very Happy</p>";
  // emailService.sendEmailWithHTML("murlivishwakarma4@gmail.com", "This is Demo
  // by Murli", htmlContent);
  // }

  // @Test
  // public void emailSenderWithAttachement() {
  // emailService.sendEmailWithFile("murlivishwakarma4@gmail.com", "Java Developer
  // role",
  ...
  // emailService.sendEmailWithInputFile("murlivishwakarma4@gmail.com", "God
  // Father",
